...
\section{Comparison joint and task space}

However, compared to the joint space motion, the task space motion took more time to execute within the constraints. A comparison of the joint velocities and accelerations for both can be viewed in figure \ref{fig:jspace_vs_tspace}.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.0\linewidth]{cus_imgs/joint_vs_task_motion.pdf}
...
\begin{table}[H]
	...
	\begin{tabular}{lcc}
	Motion type                 & duration in \si{\second} & deviation in \si{\meter} \\ \hline
	joint space trapezoidal     & 5.425                    &                          \\
	task space trapezoidal      & 9.4874                   &                          \\
	continuous w.o. via points  & 5.4211                   &                          \\
	continuous with. via points & 6.4217                   &                         
\end{tabular}
\end{table}